...
class Resource {
  ...
  private function setVariables() {
    ...
    $agnosticName = '../../' . strtolower( Config::PROJECT_NAME ) . Config::DATA_DIRECTORY . '/' . $this->_location . $this->query;
    ...
    //if (file_exists('../../' . strtolower(Config::PROJECT_NAME) . Config::DATA_DIRECTORY . '/' . $this->_location . $this->name)) {

    

    /*$di = new RecursiveDirectoryIterator('../../' . strtolower(Config::PROJECT_NAME) . Config::DATA_DIRECTORY . '/' . $this->_location);
